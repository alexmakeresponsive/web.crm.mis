...
// ts-node ./app_modules/src/model/dcMember/migration/2020-03-12-4/migration.ts
...
connection.beginTransaction(function(err) {
    ...
    connection.query(`
        ...
        function insert(member:any) {
            ...
            let query = `INSERT INTO dc_member (${keys}) VALUES (${values})`;
